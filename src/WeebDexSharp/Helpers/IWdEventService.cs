...
/// </summary>
public interface IWdEventService
{
	/// <summary>
	...
	/// <summary>
	/// Triggered whenever a weebdex response is received
	/// </summary>
	/// <param name="response">The weebdex response that was received</param>
	void OnResponse(WeebDexResponse response);
}

/// <summary>
/// Default implementation of <see cref="IWdEventService"/> that does nothing 
/// and provides easy overrides for the events you want
/// </summary>
public abstract class WdEventService : IWdEventService
{
	/// <summary>
	/// Triggered when an underlying HTTP request finished with an error
	/// </summary>
	...
	/// </summary>
	/// <param name="response">The weebdex response that was received</param>
	public virtual void OnResponse(WeebDexResponse response) { }
}
