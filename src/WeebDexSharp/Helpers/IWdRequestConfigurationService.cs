...
/// <summary>
/// A service for adding custom configuration to the underlying HTTP requests that WD api makes
/// </summary>
/// <remarks>
...
/// </remarks>
public interface IWdRequestConfigurationService
{
	/// <summary>
	...
	void Configure(string uri, HttpRequestMessage request);
}
